...
def upgrade() -> None:
    ...
    if not op.get_bind().has_table("recording"):
        op.create_table(
            "recording",
        ...
        with op.batch_alter_table("recording") as batch_op:
            if not batch_op.has_column("original_recording_id"):
                batch_op.add_column(sa.Column("original_recording_id", sa.Integer(), nullable=True))
